...
import {
  ...
  resolveRouteBackedShellApp,
  shellAppRegistry,
  type RouteBackedShellApp,
} from "../app/app-routes";
...
export function DesktopShell({
  ...
  const routeBackedApp = useMemo(
    () => resolveRouteBackedShellApp(location.pathname),
    [location.pathname],
  );
  ...
  }, [routeBackedApp, location.pathname, location.search]);
...
function ShellWindowBody({
  ...
  appId: ShellAppId;
  routeApp: RouteBackedShellApp | null;
  ...
  return (
    <div className={styles.routeHost} data-active-route-app={routeApp?.appId ?? "none"}>
